...
contract ClockAuction721 is Ownable, Pausable, ERC1155Holder {
  ...
  /// @param _nftAddress - Address of the NFT.
  function _getNftContract(address _nftAddress) internal pure returns (IERC721Custom) {
    IERC721Custom candidateContract = IERC721Custom(_nftAddress);
  ...
  function _owns(
    ...
    IERC721Custom _nftContract = _getNftContract(_nftAddress);
